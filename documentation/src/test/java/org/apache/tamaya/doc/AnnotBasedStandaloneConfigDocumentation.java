...
@ConfigSpec(
        ...
        properties = {
                @ConfigPropertySpec(keys ="log", description ="Log the server startup in detail, default: false.",
                        valueType = Boolean.class),
                @ConfigPropertySpec(keys ="refresh", description = "Refresh interval in millis, default: 1000ms",
