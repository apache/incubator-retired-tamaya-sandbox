 ...
 * </ul>
 */
public final class RefreshableConfigSource
        implements ConfigSource, Refreshable {

    private static final Logger LOG = Logger.getLogger(RefreshableConfigSource.class.getName());
    ...
    private RefreshableConfigSource(Map<String,String> metaConfig, ConfigSource wrapped) {
     ...
     */
    public static RefreshableConfigSource of(Map<String,String> metaConfig, ConfigSource propertySource) {
        if(propertySource instanceof RefreshableConfigSource){
            return (RefreshableConfigSource)propertySource;
        }
        return new RefreshableConfigSource(metaConfig, propertySource);
    }
     ...
     * @return a new instance, not null.
     */
    public static RefreshableConfigSource of(ConfigSource propertySource) {
